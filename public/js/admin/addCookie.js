    ...
    document
      ...
      .addEventListener('submit', async function (e) {
        ...
        try {
          ...
          const response = await fetch(backendAPI + 'add-cookie', {
            method: 'POST',
            headers: {
              Authorization: `Bearer ${authToken}`,
            },
          ...
          if (!response.ok) {
            ...
            if (data.errors) {
              ...
              throw new Error(
                data.error || 'Error al guardar la cookie'
              );
            }
            return;
          }
          ...
          alert('Error al guardar la cookie: ' + error.message);
        } finally {
