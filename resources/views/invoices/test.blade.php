...
<html lang="es">
	...
	<body>
		...
		<div class="main-content">
			...
			<div class="info-block company-info">
				<p class="title"><strong>Carlos Gil Daríes</strong></p>
				Dirección: Calle Alboraya 14, pta 19, Valencia<br>
				DNI: 24397291H
			</div>
			...
			<div class="info-block client-info">
				<p class="title"><strong>Cliente</strong></p>
				Nombre: SMS Mobile Marketing S.L.<br>
				Dirección: Calle Pizarro 1, pta 10, 46004, Valencia<br>
				CIF: B98286810<br>
			</div>
			...
			<table>
				...
				<tbody>
					<tr>
						<td>Desarrollo Plataforma Streaming</td>
						<td>Efectivo</td>
						<td>600 €</td>
					</tr>
					<tr>
